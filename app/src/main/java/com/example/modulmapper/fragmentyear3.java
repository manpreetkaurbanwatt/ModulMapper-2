...
public class fragmentyear3 extends Fragment implements View.OnClickListener {
    ...
    public void addModules(String pathway) {
        if (pathway.equals("web")) {
            modules = db.getModule("webCourses", 3);
            createFields();
        } else if (pathway.equals("networking")) {
            modules = db.getModule("networkCourses", 3);
            createFields();
        } else if (pathway.equals("software")) {
            modules = db.getModule("softwareCourses", 3);
            createFields();
        } else if (pathway.equals("database")) {
            modules = db.getModule("databaseCourses", 3);
            createFields();
        }
